...
class _TransactionListState extends State<TransactionList> {
  ...
  Widget build(BuildContext context) {
    return widget.transaction.isNotEmpty?ListView.builder(
          ...
          return Card(
            ...
            child: Padding(
              ...
              child: ListTile(
                ...
                trailing: IconButton(onPressed: (){widget.removeTransaction(widget.transaction[index].id);}, icon: Icon(Icons.delete,color: Colors.red,)),
              ),
            ),
          );}):Column(
